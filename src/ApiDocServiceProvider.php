<?php
namespace Biggold\Apidoc;

use Biggold\Apidoc\Commands\Clean;
use Biggold\Apidoc\Commands\Generate;
use Biggold\Apidoc\Descriptions\DefaultDesc\DefaultDescription;
use Biggold\Apidoc\Renders\DefaultRender\DefaultRender;
